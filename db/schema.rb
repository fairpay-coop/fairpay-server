...
ActiveRecord::Schema.define(version: 20160221043832) do
  ...
  add_index "dwolla_tokens", ["profile_id"], name: "index_dwolla_tokens_on_profile_id", using: :btree
  ...
  add_foreign_key "dwolla_tokens", "profiles"
